...
const servicesData = [
  ...
  {
    id: 14,
    icon: <SiHiveBlockchain size={35} />,
    title: 'Blockchain Solutions',
    description: 'Innovative blockchain solutions to enhance transparency, security, and efficiency in your business processes.',
    link: 'single-services.html',
    HovImg: Hovimg3,
  },
  {
    id: 15,
    icon: <FaShopify  size={35} />,
    title: 'Shopify Development',
    description: 'Customized Shopify solutions to create engaging and high-performing online stores tailored to your business needs.',
    link: 'single-services.html',
    HovImg: Hovimg3,
  },
  {
    id: 16,
    icon: <SiRubyonrails size={35} />,
    title: 'Ruby on Rails',
    description: 'Robust Ruby on Rails development services focused on building scalable and maintainable web applications.',
    link: 'single-services.html',
    HovImg: Hovimg3,
  },
