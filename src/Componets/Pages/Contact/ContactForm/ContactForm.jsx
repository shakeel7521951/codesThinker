            ...
            <div className="bg-[#0f0f1d] border rounded-lg p-8">
              ...
              <form id="contact-form" className="space-y-4" action="mail.php" method="POST">
                <div className="form-group">
                  <input type="text" name="name" id="name" className="form-control w-full p-3 border bg-gray-200 border-gray-300 rounded-md" required placeholder="Your Name" />
                </div>
                <div className="form-group">
                  <input type="email" name="email" id="email" className="form-control w-full bg-gray-200 p-3 border border-gray-300 rounded-md" required placeholder="Your Email" />
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  <button type="submit" className="btn bg-[#EFA41C] text-white px-6 py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">Send Message</button>
                </div>
                   </a>
              </form>
            </div>
