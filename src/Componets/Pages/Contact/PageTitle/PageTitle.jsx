...
const PageTitle = ({title,Sub}) => {
  ...
  return (
    <div className="bg-[#162466] py-32 font-ui-sans-serif "
    style={{
      ...
      backgroundRepeat: 'no-repeat',
          ...
          <div className='absolute top-[80px] h-[20rem] inset-0 bg-[#121225] opacity-50 ' aria-hidden='true'></div>
          <div className="flex  flex-col items-center justify-center" data-aos="fade-right">
            <div className="flex  space-x-5">
              <h1 className="text-white text-3xl font-bold font-ui-sans-serif">{title}</h1>
            </div>
