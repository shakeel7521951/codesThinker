...
const allProjects = [
  { id: 1, title: 'Clikkle', para:"Clikkle Web is an innovative web application designed to streamline user interactions with a focus on simplicity and efficiency. Built with a responsive and intuitive UI,", link:'https://clikkle.com/', backgroundImage:Bg1 },
  { id: 2, title: 'School Management System', para:"School management web application designed to streamline administrative tasks, enhance communication, and improve the overall efficiency of educational institutions.", link:'https://schcube.com/', backgroundImage:Bg2 },
  { id: 3,title: 'Advocate Iron Tech', para:"Advocate Iron Tech is a professional website developed to serve legal practitioners and law firms, offering a modern platform that streamlines client management, case tracking, and legal documentation.", backgroundImage:Bg3 },
];
...
const ProjectHome2 = () => {
          ...
          <div className='lg:grid grid-cols-3 justify-around gap-8'>
            {allProjects.map(project => (
              <div key={project.id} className="w-full p-4">
                ...
                >
                  <div className="absolute inset-0 bg-[#18354b] bg-opacity-70 rounded-lg"></div>
                  <div className="relative py-20 px-3 text-justify">
                    <h3 className="text-sm md:text-lg font-semibold text-white mb-2 text-center">
                      {project.title}
                    </h3>
                    <p className="text-gray-300 text-sm md:text-base">{project.para}</p>
                  </div>
                </motion.div>
                </Link>
              </div>
  ...
  return (
    <section id="project" className="bg-[#121225] py-16 px-4 pb md:px-10">
      <div className="container mx-auto">
        <div className="text-center mb-12 space-y-4">
          <h6 className="text-lg text-gray-300">Featured Works</h6>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-300">Latest Study Case</h2>
          <nav>
            <ul className="flex flex-wrap justify-center gap-4">
              ...
              >
                <Link to="#" className='text-white'>All Projects</Link>
              </li>
              <li
                className="px-4 py-2 cursor-pointer"
              >
                <Link to="#" className='text-white'>IT Solutions</Link>
              </li>
              <li
                className="px-4 py-2 cursor-pointer"
              >
                <Link to="#" className='text-white'>Digital Solutions</Link>
              </li>
              <li
                className="px-4 py-2 cursor-pointer"
              >
                <Link to="#" className='text-white'>App Development</Link>
              </li>
            </ul>
          </nav>
        </div>
